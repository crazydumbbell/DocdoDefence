...
namespace OccaSoftware.Altos.Runtime
{
    internal class TemporalAA
    {
        ...
        public ProjectionMatrices SetupMatrices(Camera camera)
        {
            ProjectionMatrices m;

            m.prevViewProjection = GetPreviousViewProjection(camera);
            m.projection = GL.GetGPUProjectionMatrix(camera.nonJitteredProjectionMatrix, true);
            ...
            SetPreviousViewProjection(camera, m.viewProjection);
