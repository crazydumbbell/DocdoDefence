...
namespace OccaSoftware.Altos.Runtime
{
    ...
    internal sealed class AltosRenderFeature : ScriptableRendererFeature
    {
        ...
        public override void Create()
        {
            ...
            screenShadowsPass.renderPassEvent = RenderPassEvent.BeforeRenderingTransparents - 3;

            atmospherePass = new AtmosphereBlendingPass();
            atmospherePass.renderPassEvent = RenderPassEvent.BeforeRenderingTransparents - 2;

            cloudRenderPass = new VolumetricCloudsRenderPass();
            cloudRenderPass.renderPassEvent = RenderPassEvent.BeforeRenderingTransparents - 1;
        }
